...
const SYNONYMS: Record<string, string[]> = {
  ...
  // Σκόπιμα ΧΩΡΙΣ «πελάτης»: σε άλλες εταιρείες η στήλη «Πελάτης» είναι
  // όνομα, όχι κωδικός — καλύτερα να το βάλει ο χρήστης μία φορά παρά να
  // μπει με σιγουριά σε λάθος πεδίο.
  client_code: ["κωδικος", "κωδικος πελατη", "code"],
  client_name: ["πελατης", "ονοματεπωνυμο", "επωνυμια", "ασφαλισμενος", "ονομα", "client", "name"],
  client_father_name: ["πατρωνυμο", "πατερας"],
  client_afm: ["αφμ", "α.φ.μ", "α.φ.μ.", "vat", "tin"],
  client_doy: ["δου", "δ.ο.υ", "δ.ο.υ."],
  client_email: ["email", "e-mail", "ηλ. ταχυδρομειο"],
  client_phone: ["κινητο", "τηλεφωνο", "phone", "τηλ", "mobile"],
  client_landline: ["σταθερο", "τηλεφωνο2", "landline"],
  client_address: ["διευθυνση", "οδος", "address"],
  client_city: ["πολη", "city"],
  client_postal_code: ["τκ", "τ.κ", "τ.κ.", "ταχ. κωδικας", "postal"],
