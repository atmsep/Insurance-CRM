...
import { sendPolicySms, type SendMessageState } from "./actions";
...
export function SendSmsButton({
  ...
  const [state, formAction, pending] = useActionState<SendMessageState, FormData>(
    sendPolicySms.bind(null, policyId),
    undefined,
  );
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Αποστολή SMS στον πελάτη</DialogTitle>
        </DialogHeader>
