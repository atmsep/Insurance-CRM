...
export function DefaultRewardRuleDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Γενικός κανόνας προμήθειας συστάσεων</DialogTitle>
          <DialogDescription>
            Ισχύει για όλη την εφαρμογή. Εφαρμόζεται αυτόματα σε κάθε συμβόλαιο σύστασης που δεν έχει ήδη
            χειροκίνητο κανόνα — όσα έχεις ρυθμίσει μεμονωμένα δεν αλλάζουν. Μπορείς να το τρέξεις ξανά
            όποτε προστεθεί νέο συμβόλαιο.
          </DialogDescription>
        </DialogHeader>
